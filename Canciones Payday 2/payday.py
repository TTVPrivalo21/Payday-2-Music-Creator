...
def main():
    ...
    archivos_audio = [f for f in os.listdir(INPUT_FOLDER) if f.lower().endswith((".mp3", ".ogg"))]
    
    if not archivos_audio:
        print(f"⚠️ No se encontraron canciones. Por favor, pon tus MP3 u OGG en la carpeta '{INPUT_FOLDER}'.")
        return

    for file in archivos_audio:
